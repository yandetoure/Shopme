        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="purchase_price" name="purchase_price" value="{{ old('purchase_price', $product->purchase_price) }}" step="1" min="0"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                </div>
                ...
                <div>
                    ...
                    <select id="sale_unit" name="sale_unit"
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">
                        <option value="unit" {{ old('sale_unit', $product->sale_unit ?? 'unit') == 'unit' ? 'selected' : '' }}>Unité</option>
                        <option value="dozen" {{ old('sale_unit', $product->sale_unit ?? 'unit') == 'dozen' ? 'selected' : '' }}>Douzaine</option>
                    </select>
                </div>
                ...
                <div>
                    <label class="flex items-center mt-6">
                        <input type="checkbox" name="is_discovery" value="1" {{ old('is_discovery', $product->is_discovery) ? 'checked' : '' }}
                               class="mr-2">
