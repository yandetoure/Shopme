...
@section('title', 'Créer un Produit - ShopMe')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="short_description" name="short_description" rows="2"
                              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">{{ old('short_description') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent">{{ old('description') }}</textarea>
                </div>
                        ...
                        @foreach($categories as $category)
                            <label class="flex items-center">
                                <input type="checkbox" name="categories[]" value="{{ $category->id }}"
                                       class="mr-2" {{ in_array($category->id, old('categories', [])) ? 'checked' : '' }}>
                ...
                <div class="md:col-span-2">
                    ...
                    <div x-data="{ images: [] }" class="space-y-4">
                        ...
                        <p class="text-xs text-gray-500">Vous pouvez sélectionner plusieurs images à la fois</p>
                    </div>
                </div>
            </div>
